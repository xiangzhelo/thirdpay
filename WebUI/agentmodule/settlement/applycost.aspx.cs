...
{
    public partial class Applycost : AgentPageBase
    {
                        ...
                        else
                        {
                            ...
                            if (string.IsNullOrEmpty(msg))
                            {
                                ...
                                if (settlementAccount != null)
                                {
                                    ...
                                    {
                                        itemInfo.SuppId = chnlBLL.GetSupplier(itemInfo.PayeeBank);
                                    ...
                                    if (result > 0)
                                    {
                                        ...
                                        //if (itemInfo.status == SettledStatus.付款接口支付中)
                                        //{
                                        //    viviapi.ETAPI.Common.Withdraw.InitDistribution(itemInfo);
                                        //}
                                    }
                                    else
                                    {
