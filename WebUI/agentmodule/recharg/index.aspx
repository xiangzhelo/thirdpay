<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.recharg.index" %>
    ...
    <div id="frame-wrapper">
        ...
        <div id="frame-header">
            ...
            <ul id="headerNav">
                ...
                <li class="current"><a href="/agentmodule/recharg/index.aspx">账户充值</a></li>
        ...
        <div id="frame-content">
            <div class="mainbar">
                <div class="module" style="height: 823px;">
                    <iframe src="recharge.aspx" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto"
                    ...
                    <div class="mbody" style="height: 793px;">
                        <div class="sideNav-content" style="height: 759px;">
                            ...
                            <ul id="side-menu" class="text-nav">
                                <li class="current"><a href="recharge.aspx" target="mainframe"><i class="icon-nav"></i>账户充值</a></li>
