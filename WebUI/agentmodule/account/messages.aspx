<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="messages.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.account.Messages" %>
    ...
    <script type="text/javascript">
        ...
        function SelectAll(box) {
            for (var i = 0; i < document.form1.elements.length; i++) {
                ...
                if ((e.type == 'checkbox')) {
                    var o = e.name.lastIndexOf('MsgId');
                    if (o != -1) {
                    ...
                    <ItemTemplate>
                        <tr role="row">
                            <td align="center" bgcolor="#FFFFFF">
                                <input id="chkItem<%#Eval("id") %>" type="checkbox" value='<%#Eval("id")%>' name="MsgId" />
                            </td>
                            ...
                            <td height="30" align="center" bgcolor="#FFFFFF">
                             ...
                             <td height="30" align="center" bgcolor="#FFFFFF">
                                <a href="javascript:viewmsg('<%#Eval("id")%>');">查看</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
