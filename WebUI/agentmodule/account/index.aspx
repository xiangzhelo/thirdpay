<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.account.index" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="/agentmodule/css/frame.css" />

    <script src="/agentmodule/js/jquery-1.8.1.min.js"></script>
    <script src="/agentmodule/js/jquery.hoverdelay.js"></script>
    <script src="/agentmodule/js/frame.js"></script>
    <script type="text/javascript" src="../js/jquery.artDialog.js"></script>
    <script src="/agentmodule/js/jquery.qtip.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="/agentmodule/js/hermes.js"></script>
...
<body>
    ...
    <div id="frame-wrapper">
        ...
        <div id="frame-header">
            ...
            <ul id="headerNav">
                <li class="current"><a href="/agentmodule/account/index.aspx">我的账户</a></li>
