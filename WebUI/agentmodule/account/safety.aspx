<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="safety.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.account.Safety" %>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <span class="help-inline">上次登录时间：<%= LastLoginTime%></span>
                            </td>
                            <td style="width: 100px;" class="tcenter">
                                <a href="/usermodule/safety/repassword.aspx" class="btn btn-primary">修改</a>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 350px">
                            ...
                            <td style="width: 100px;" class="tcenter">
                                <a href="/usermodule/safety/cashpass.aspx" class="btn btn-primary">
                                    <%=gettxbtn %></a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 100px;" class="tcenter">
                                <a href="/usermodule/safety/safeques.aspx" class="btn btn-primary">
                                    <%=getmbbtn %></a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 100px;" class="tcenter">
                                <a href="/usermodule/safety/modiphone.aspx" class="btn btn-primary">
                                    <%=getphonebtn %></a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 100px;" class="tcenter">
                                <a href="/usermodule/safety/<%=getemailurl%>.aspx" class="btn btn-primary">
                                    <%=getemailbtn %></a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 100px;" class="tcenter">
                                <a href="/usermodule/safety/safetrna.aspx" class="btn btn-primary">
                                    <%=getidcardbtn %></a>
                            </td>
                        </tr>
                    </tbody>
