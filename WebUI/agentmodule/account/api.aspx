<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="api.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.account.API" %>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td height="50" colspan="3" align="center" class="line_01" valign="top">
                    <img alt="" src="/agentmodule/images/apitop.png" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="line_01" style="padding-left: 20px; border: none;">
                    <a href="" target="_blank" class="btn btn-primary">翁贝网关说明文档【点击下载】</a> <a href=""
                        target="_blank" class="btn btn-primary">龙宝销卡寄售接口说明文档【点击下载】</a>
                </td>
