<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.account.Feedback" %>
...
<body style="background: white;">
    ...
    <div id="list_content">
        <%-- <div id="title">
            留言反馈&nbsp;<img id="loading" width="0" height="0" src="/agentmodule/static/style/image/008.gif" /></div>--%>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td height="22" align="center" class="font8">
                    <asp:LinkButton ID="b_save" runat="server"  CssClass="btn btn-primary" 
                        onclick="b_save_Click" >保存</asp:LinkButton>
                </td>
                &nbsp;
                <td align="right">
                    &nbsp;
