<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modiphone.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.safety.Modiphone" %>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            ...
            $("a#sendmsg").click(function() {
                ...
                $.get("/usermodule/ws/SendPhoneVerifyCode.ashx?t=" + Math.random(), { phone: phoneno },
    ...
    <div id="list_content">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td align="left" class="line_01" style="padding-left: 15px; border: none;">
                    <asp:LinkButton ID="btnSave" runat="server" Text="保存修改" CssClass="btn btn-primary" OnClick="lbtnSave_Click" />&nbsp;
