<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="safetrna1.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.safety.Safetrna1" %>
...
<body>
    ...
    <div id="list_content">
        <div id="title">
            实名认证&nbsp;<img id="loading" width="0" height="0" src="/usermodule/static/style/008.gif" /></div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td height="22" align="left" class="font8">
                    <asp:Button ID="btnSure" runat="server" Text="确认无误" CssClass="button_01" OnClick="btnSure_Click" />
                    &nbsp;
                    <td align="right">
                        &nbsp;
                    </td>
