...
{
    public partial class agentordercards : viviapi.WebComponents.Web.AgentPageBase
    {
        ...
        private void LoadData()
        {
            ...
            listParam.Add(new SearchParam("agentid", this.UserId));
            ...
            if (!string.IsNullOrEmpty(txtuserid.Value.Trim()))
            {
                if (int.TryParse(txtuserid.Value.Trim(), out tempId))
                {
