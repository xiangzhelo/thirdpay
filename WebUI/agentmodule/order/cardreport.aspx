<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cardreport.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.order.cardreport" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function replenish(orderid) {
            $.get("/usermodule/ws/CardReplenish.ashx?t=" + Math.random(), { type: "2", order: orderid },
                ...
                <asp:Repeater ID="rptOrders" runat="server" OnItemDataBound="rptDetails_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td height="30" align="center" bgcolor="#FFFFFF">
                                <%#viviapi.SysInterface.Card.Utility.GetVersionName(Eval("version").ToString())%>
                            </td>
                            <td height="30" align="center" bgcolor="#FFFFFF">
                                <%#viviapi.BLL.Order.Card.CardNotify.Instance.GetNotifyStatViewText(Eval("notifystat"))%> 
                            </td>
                            <td height="30" align="center" bgcolor="#FFFFFF">
