<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.order.Index" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>翁贝充值卡寄售平台</title>
    <meta name="description" content="">
    <link href="/agentmodule/images/favicon.ico" rel="shortcut icon" type="image/ico">
...
<body>
    ...
    <div id="frame-wrapper">
        ...
        <div id="frame-header">
            <div id="logo">
                <a href="/agentmodule/account/index.aspx">
                    <img src="../images/logo2.gif" alt=""></a></div>
            <ul id="headerNav">
                <li class=""><a href="/agentmodule/account/index.aspx">我的账户</a></li>
                <li class="current"><a href="/agentmodule/order/index.aspx">订单管理</a></li>
                <li class=""><a href="/agentmodule/product/index.aspx">商品管理</a></li>
                <li class=""><a href="/agentmodule/settlement/index.aspx">结算提现</a></li>
                <li class=""><a href="/agentmodule/recharg/index.aspx">账户充值</a></li>
                <li class=""><a href="/agentmodule/behalf/index.aspx">对私代发</a></li>
            </ul>
            <ul id="header-info">
               <li class="item user-info hoverToggle-wrapper"><a href="javascript:void(0);" class="hoverToggle-trigger">
                ...
                <li class="item return-desktop"><a href="/agentmodule/account/index.aspx" data-hasqtip="0"
                    oldtitle="" title="返回首页"><i class="icon-top icon-top-desktop"></i></a></li>
                <li class="item messages-top"><a href="/agentmodule/account/messages.aspx" target="mainframe"
                    class="link-message" title="未读信息 <%=getmsgcount %>  条"><span id="msghead" class="badge badge-error"><%=getmsgcount %> </span><i
                        class="icon-top icon-top-message"></i> </a></li>
                <li class="item top-exit last-item"><a href="/agentmodule/logout.aspx" data-hasqtip="3"
                    oldtitle="" title="退出"><i class="icon-top icon-top-exit"></i></a></li>
            </ul>
        </div>
        <!-- sider & main -->
        <div id="frame-content">
            <div class="mainbar">
                <div class="module" style="height: 823px;">
                    <iframe src="agentorderbank.aspx" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto"
                    ...
                    <div class="mbody" style="height: 793px;">
                        <div class="sideNav-content" style="height: 759px;">
                            ...
                            <ul id="side-menu" class="text-nav">
                                ...
                                <li class="current"><a href="agentorderbank.aspx" target="mainframe"><i class="icon-nav">
                                </i>网银代理</a></li>
                                <li ><a href="agentordercards.aspx" target="mainframe"><i class="icon-nav">
                                </i>卡类代理</a></li>
                                
                                 <li><a href="orderbank.aspx" target="mainframe"><i class="icon-nav"></i>网银订单</a></li>
                                <li><a href="ordercards.aspx" target="mainframe"><i class="icon-nav"></i>卡类订单</a></li>
        ...
        <div id="frame-footer">
            <ul class="footer-info">
                    ...
                    <div class="hoverToggle hoverToggle-bottomRight service-popup">
                        <div class="mbody">
                            <dl>
                                ...
                                <dd>
                                    <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=240472266&site=qq&menu=yes">
                                        <img border="0" src="../images/pa" alt="点击这里给我发消息" data-hasqtip="2" oldtitle="点击这里给我发消息"
                                            title="">
                                    </a>
                                </dd>
                            </dl>
                            <dl>
                                <dt>客服电话：</dt>
                                <dd>
                                    <b class="red">400-6539930</b></dd>
                            </dl>
                            <p class="tcenter">
                                <a target="mainframe" href="/agentmodule/account/feedbacks.aspx" class="btn">问题反馈</a></p>
                        </div>
                        <div class="mfooter">
                            &nbsp;</div>
                    </div>
                ...
                <li class="item clickToggle-wrapper last-item"><a href="javascript:void(0);" class="trigger">
                    <i class="icon icon-comment"></i>通知 <span id="msgfoot2" class="badge badge-error"><%=getmsgcount %> </span></a>
                    <div class="clickToggle hoverToggle-bottomLeft notify-popup">
                        <a href="javascript:void(0);" class="close">×</a>
                        <div class="mbody">
                            <div class="alert">
                                <a href="/agentmodule/account/messages.aspx" target="mainframe">未读信息</a> <span id="msgfoot"
                                    class="badge badge-error"><%=getmsgcount %> </span>
                            </div>
                        </div>
                        <div class="mfooter">
                            &nbsp;</div>
