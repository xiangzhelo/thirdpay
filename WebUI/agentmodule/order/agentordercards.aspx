<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agentordercards.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.order.agentordercards" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function replenish(orderid) {
            $.get("/usermodule/ws/cardreplenish.ashx?v=" + Math.random(), { type: "2", order: orderid },
