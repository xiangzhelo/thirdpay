<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agentorderbank.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.order.agentorderbank" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="/agentmodule/static/js/ejs/skin/vista/ymPrompt.css" />
    ...
    <script src="/agentmodule/static/js/ejs/ymPrompt.js" type="text/javascript"></script>
    <script type="text/javascript" src="/agentmodule/static/js/date.js"></script>

    <script type="text/javascript">
        function replenish(orderid) {
            $.get("/agentmodule/ws/bankreplenish.ashx?v=" + Math.random(), { order: orderid },
        ...
        <div id="search">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                        <!--工具栏-->
                        &nbsp; 商户ID： <input id="txtuserid" runat="server" type="text"  maxlength="30" value="" class="search_txt_01" />
