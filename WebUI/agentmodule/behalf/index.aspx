<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="viviAPI.WebUI7uka.agentmodule.behalf.index" %>
    ...
    <div id="frame-wrapper">
        ...
        <div id="frame-header">
            ...
            <ul id="headerNav">
                ...
                <li class=""><a href="/agentmodule/order/index.aspx">订单管理</a></li>
                ...
                <li class="current"><a href="/agentmodule/behalf/index.aspx">对私代发</a></li>
            </ul>
            <ul id="header-info">
                    ...
                    <div class="mbody" style="height: 793px;">
                        <div class="sideNav-content" style="height: 759px;">
                            ...
                            <ul id="side-menu" class="text-nav">
                                <li class="current"><a href="import.aspx" target="mainframe"><i class="icon-nav"></i>代发上传</a></li>
