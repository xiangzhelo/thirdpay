<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviAPI.WebUI7uka.agent.Left" Codebehind="Left.aspx.cs" %>
            ...
            <tr class="tdbg">
                <td valign="top" class="left_color" id="menubar">
                    <div id="left0" style="display: ">
                        ...
                        <div style="padding-top: 10px"></div>                    
                        <a id="a1" runat="server" target="rightframe" href="Order/BankList.aspx">网银订单查询</a>
                        <a id="a2" runat="server" target="rightframe" href="Order/CardList.aspx">点卡订单查询</a>
                        <a id="a4" runat="server" target="rightframe" href="orderreport2.aspx">统计分析</a>
