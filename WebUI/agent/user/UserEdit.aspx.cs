...
namespace viviAPI.WebUI7uka.agent.user
{
    ...
    /// 
    /// </summary>
    public partial class UserEdits : AgentPageBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public UserInfo model
        {
            get
            {
                if (_ItemInfo == null)
                {
                    ...
                    {
                        _ItemInfo = viviapi.BLL.User.Factory.GetModel(this.ItemInfoId);
                    }
                    else
                    {
        ...
        void ShowInfo()
        {
            ...
            {
                UserInfo promSuper = viviapi.BLL.User.Factory.GetPromSuperior(model.ID);
