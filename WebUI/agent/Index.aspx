<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviAPI.WebUI7uka.agent.Index" Codebehind="Index.aspx.cs" %>
                    ...
                    <div>
                        <div class="left b_size" style="margin: 1px; width: 99%">
                            <div class="addrtitle f_size">
                                ...
                                <p>
                                    代理当月提成：<%=monthcommission%>元</p>
                                  <p> 推广连接获取：http://www.wengpay.com/Regedit.html<asp:Literal ID="litlinks" runat="server"></asp:Literal>     
                                  </p>
                            </div>
                        </div>
                    </div>
