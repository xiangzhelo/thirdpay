...
namespace viviAPI.WebUI7uka
{
    ...
    /// 
    /// </summary>
    public partial class agentlogin : PageBase
    {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (errMsg == "success")
            {
                AlertAndRedirect("", "/agentmodule/account/index.aspx");
            }
            else
            {
        ...
        public string SignIn()
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(message))
                {
                    ...
                    message = viviapi.BLL.User.Login.SignIn(0, 1,userName, Cryptography.MD5(userPwd), lastLoginIp, lastLoginAddress);
