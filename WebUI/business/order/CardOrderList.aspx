<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.web.business.Order.CardOrderList" Codebehind="CardOrderList.aspx.cs" %>
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFF3FB" ondblclick="javascript:sendInfo('<%# Eval("id")%>')">
                                            ...
                                            <td id="tr_supplier" runat="server">
                                                <%# viviapi.web.WebUtility.GetsupplierName(Eval("supplierId"))%>
                                            </td>
                                            <td>
                                                <%# Eval("server")%>
                                            </td>
                                        ...
                                        <tr id="tr_carddetail" runat="server" style="display:none">
                                            <td colspan="20">
                                                ...
                                                <td>
                                                    &nbsp;<%# viviapi.web.WebUtility.GetsupplierName(Eval("suppid"))%>
                                                </td>  
                                                <td>
