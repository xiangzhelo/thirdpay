...
{
    public partial class BankReportList : viviapi.WebComponents.Web.BusinessPageBase
    {
        /// <summary>
        /// 交易金额
        /// </summary>
        ...
        private void LoadData()
        {
            ...
            DataSet pageData = viviapi.BLL.Order.Bank.Factory.Instance.PageSearch(listParam, this.Pager1.PageSize, this.Pager1.CurrentPageIndex, orderby,false);
