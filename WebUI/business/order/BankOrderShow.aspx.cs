...
namespace viviapi.web.business.Order
{
    ...
    /// 
    /// </summary>
    public partial class BankOrderShow : viviapi.WebComponents.Web.BusinessPageBase
    {
        public long Id
        {
            get
        ...
        private void ShowInfo(long id)
        {
            ...
            var model = viviapi.BLL.Order.Bank.Factory.Instance.GetModel(Id);
            ...
            lblversion.Text = viviapi.SysInterface.Bank.Utility.GetVersionName(model.version);
        }
