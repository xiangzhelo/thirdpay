...
namespace viviapi.web.business.User
{
    ...
    /// 
    /// </summary>
    public partial class UserLoginLog : viviapi.WebComponents.Web.BusinessPageBase
    {
   ...
   , ManageRole.Merchant);
        ...
        private void LoadData()
        {
            ...
            DataSet pageData = BLL.User.UserLoginLogFactory.PageSearch(listParam, this.Pager1.PageSize, this.Pager1.CurrentPageIndex, string.Empty);
