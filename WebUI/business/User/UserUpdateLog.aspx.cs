...
namespace viviapi.web.business.User
{
    ...
    /// 
    /// </summary>
    public partial class UserUpdateLog : viviapi.WebComponents.Web.BusinessPageBase
    {
...
, ManageRole.Merchant);
        ...
        private void LoadData()
        {
            ...
            DataSet pageData = BLL.User.Factory.UpdateLogPageSearch(listParam, this.Pager1.PageSize, this.Pager1.CurrentPageIndex, string.Empty);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(selids))
            {
                foreach (string id in selids.Split(','))
                {
                    ...
                    {
                        BLL.User.UserLoginLogFactory.Del(_id);
                    }
                }
            }
            this.LoadData();
        ...
        protected void btnDel_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(selids))
            {
                foreach (string id in selids.Split(','))
                {
                    ...
                    if (int.TryParse(id, out _id))
                    {
                        BLL.User.Factory.DelUpdateLog(_id);
                    }
                }
            }
            this.LoadData();
