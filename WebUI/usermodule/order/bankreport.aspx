<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bankreport.aspx.cs" Inherits="viviAPI.WebUI7uka.usermodule.order.bankreport" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function replenish(orderid) {
            $.get("/usermodule/ws/bankreplenish.ashx?t=" + Math.random(), { order: orderid },
