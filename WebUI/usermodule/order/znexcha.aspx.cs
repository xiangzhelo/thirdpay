...
{
    public partial class znexcha : viviapi.WebComponents.Web.UserPageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
              ...
              // viviapi BLL.OrderCard orderBLL = new BLL.OrderCard();
                DataSet pageData = viviapi.BLL.Order.Card.Factory.Instance.PageSearch(listParam, 20, 1, string.Empty,false);
