<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderlist.aspx.cs" Inherits="viviAPI.WebUI7uka.usermodule.order.orderlist" %>
                ...
                <tr>
                    <td>
                        ...
                        <select id="channelId" runat="server" class="search_txt_01">
                            ...
                            <option value="207">微信</option>
                             <option value="1005">QQ支付</option>
                        </select>
                        &nbsp;状态:
