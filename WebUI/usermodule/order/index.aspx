<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="viviAPI.WebUI7uka.usermodule.order.Index" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>亿付商务网支付平台</title>

    <meta name="description" content="">
    <link href="/usermodule/images/favicon.ico" rel="shortcut icon" type="image/ico">
...
<body>
    ...
    <div id="frame-wrapper">
        ...
        <div id="frame-header">
            ...
            <ul id="headerNav">
                <li class=""><a href="/usermodule/account/index.aspx">我的账户</a></li>
                <li class="current"><a href="/usermodule/order/index.aspx">订单管理</a></li>
        ...
        <div id="frame-content">
            <div class="mainbar">
                <div class="module" style="height: 823px;">
                    <iframe src="orderbank.aspx" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto"
                    ...
                    <div class="mbody" style="height: 793px;">
                        <div class="sideNav-content" style="height: 759px;">
                            ...
                            <ul id="side-menu" class="text-nav">
                                 <li><a href="orderlist.aspx" target="mainframe"><i class="icon-nav"></i>所有订单</a></li>
          <%--                      <li class="current"><a href="orderbank.aspx" target="mainframe"><i class="icon-nav">
                                </i>网银订单</a></li>   

                                 <li><a href="orderweixin.aspx" target="mainframe"><i class="icon-nav"></i>微信订单</a></li>
                                   <li><a href="orderalipay.aspx" target="mainframe"><i class="icon-nav"></i>支付宝订单</a></li>
                                   <li><a href="ordertenpay.aspx" target="mainframe"><i class="icon-nav"></i>财付通订单</a></li>
                                ...
                                <li><a href="excha.aspx" target="mainframe"><i class="icon-nav"></i>批量销卡</a></li>
                                 <li><a href="znexcha.aspx" target="mainframe"><i class="icon-nav"></i>智能销卡</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
