    ...
    public class QueryOrderInfo : UserHandlerBase
    {
        ...
        public override void OnLoad(HttpContext context)
        {
            ...
            try
            {
                ...
                int supp =cardInfo.supplierId;

                //viviapi.ETAPI.Common.OrderCardUtils.QueryOrder(supp, decimal.ToInt32(cardInfo.refervalue), cardInfo.orderid);
                //cardInfo = Factory.Instance.GetModel(Oid);
                if (cardInfo != null)
                {
