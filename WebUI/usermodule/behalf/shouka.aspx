<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shouka.aspx.cs" Inherits="viviAPI.WebUI7uka.usermodule.behalf.shouka" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>亿付充值卡寄售平台</title>
        ...
        <div id="frame-header">
            ...
            <ul id="headerNav">
                ...
                <li class=""><a href="/usermodule/behalf/index.aspx">对私代发</a></li>
                   <li class="current" ><a href="/usermodule/behalf/shouka.aspx">点卡消耗</a></li>
            </ul>
            <ul id="header-info">
        ...
        <div id="frame-content">
            <div class="mainbar">
                <div class="module" style="height: 823px;">
                    <iframe src="../order/znexcha.aspx" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto"
                    ...
                    <div class="mbody" style="height: 793px;">
                        <div class="sideNav-content" style="height: 759px;">
                            ...
                            <ul id="side-menu" class="text-nav">
                                ...
                                <li class="current"><a href="../order/znexcha.aspx" target="mainframe"><i class="icon-nav"></i>智能提交</a></li>
                                <li><a href="../order/excha.aspx" target="mainframe"><i class="icon-nav"></i>普通提交</a></li>
                     
                                <li><a href="../order/exchalist.aspx" target="mainframe"><i class="icon-nav"></i>消耗记录</a></li>
                    ...
                    <div class="hoverToggle hoverToggle-bottomRight service-popup">
                        <div class="mbody">
                            <dl>
                                <dt>在线客服：</dt>
                                <dd>
                                    <a target="_blank" href="http://www.7uka.com/service.html">
                                        进入客服中心
                                    </a>
                                </dd>
                            </dl>
