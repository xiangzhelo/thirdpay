<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info.aspx.cs" Inherits="viviAPI.WebUI7uka.usermodule.account.Info" %>
...
<body>
    ...
    <div id="list_content">
        <div id="title">
            基本信息&nbsp;<img id="loading" width="0" height="0" src="/usermodule/static/style/image/008.gif" /></div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="color: Black;">
            ...
            <tr>
                <td height="45" align="right" style="font-weight: bold;">
                    商户状态：
                </td>
            ...
            <tr>
                <td height="42" colspan="2" align="left" class="line_01" style="font-size: 16px;line-height: 22px;">
                    <h3>
                       商务联系 <span style="color: Red; font-weight: bold; font-size: 12px;">如需修改信息资料，请联系商务QQ</span> </h3>
                </td>
            </tr>
            <tr>
                <td height="60" align="left" class="line_01" style="border: none; padding-left: 50px;
                    line-height: 30px;" colspan="2" valign="bottom">
                   
			<ul><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=325915361&amp;site=qq&amp;menu=yes">
                        <img border="0" src="http://wpa.qq.com/pa?p=2:139070998:51" alt="点击这里给我发消息" title="点击这里给我发消息"></a>
			<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=325915362&amp;site=qq&amp;menu=yes">
			<img border="0" src="http://wpa.qq.com/pa?p=2:139070998:51" alt="点击这里给我发消息" title="点击这里给我发消息"></a>
			<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=325915363&amp;site=qq&amp;menu=yes">
			<img border="0" src="http://wpa.qq.com/pa?p=2:139070998:51" alt="点击这里给我发消息" title="点击这里给我发消息"></a>
			<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=325915364&amp;site=qq&amp;menu=yes">
			<img border="0" src="http://wpa.qq.com/pa?p=2:139070998:51" alt="点击这里给我发消息" title="点击这里给我发消息"></a>
                </td>
            </tr>
        </table>
