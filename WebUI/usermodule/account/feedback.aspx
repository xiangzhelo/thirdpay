<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback.aspx.cs" Inherits="viviAPI.WebUI7uka.usermodule.account.Feedback" %>
...
<body style="background: white;">
    ...
    <div id="list_content">
        <%-- <div id="title">
            留言反馈&nbsp;<img id="loading" width="0" height="0" src="/usermodule/static/style/image/008.gif" /></div>--%>
