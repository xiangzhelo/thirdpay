        ...
        <div id="panel-wrapper">
            ...
            <div id="panel-content">
                    ...
                    <div class="portlet notifycation-portlet">
                        <div class="module">
                            ...
                            <div class="portlet-content">
                                ...
                                <p id="createtime">
                                    <asp:Literal ID="lit_news_publish_time" runat="server"></asp:Literal>
                                </p>
                                <p id="content">
                ...
                <div id="columnB" class="column columnRight">
                    ...
                    <div class="balance-info" id="Unavailable" runat="server" style="margin-top: -69px; margin-left: 500px">
                        <h4>未结算余额</h4>
                        <ul class="horizonal">
                            <li>
                    ...
                    <div class="balance-info" style="margin-top: -74px; margin-left: 300px">
                        <h4>提现处理</h4>
                        <ul class="horizonal">
                            <li>
                    ...
                    <div class="balance-info" style="margin-top: -69px; margin-left: 500px">
                        <h4>冻结余额</h4>
                        <ul class="horizonal">
                            <li>
                    ...
                    <div class="portlet business-portlet">
                        <div class="module">
                            <div class="portlet-header">
                                <h3>今日统计以下额度总计：<span id="txtquota_all" runat="server" ></span>元</h3>
                            ...
                            <div id="stat" class="portlet-content">
                                <table class="table table-striped centered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <span id="type_AG" runat="server" class="num">0</span>
                                            </td>
                                            <td>
                                                <span id="type_BBIN" runat="server" class="num success">0</span>
                                            </td>
                                            <td>
                                                <span id="type_MG" runat="server" class="num warning">0</span>
                                            </td>
                                            <td>
                                                <span id="type_OG" runat="server" class="num red">0</span>
                                            </td>
                                              <td>
                                                <span id="type_HG" runat="server" class="num">0</span>
                                            </td>
                                            <td>
                                                <span id="type_PT" runat="server" class="num success">0</span>
                                            </td>
                                            <td>
                                                <span id="type_EBET" runat="server" class="num warning">0</span>
                                            </td>
                                    ...
                                    <table id="dataTable" class="table table-bordered table-striped centered dataTable"
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            ...
                                            <%}
                                                ...
                                                { %>
                                            <tr class="odd">
                                                <td valign="top" colspan="6" class="dataTables_empty">没有符合条件的记录
                                                </td>
                                            </tr>
                                            <%} %>
                                        </tbody>
