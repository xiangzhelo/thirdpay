<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="api.aspx.cs" Inherits="viviAPI.WebUI7uka.usermodule.account.API" %>
...
<body>
    ...
    <div id="list_content">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td height="50" colspan="3" align="center" class="line_01" valign="top">
                    <img alt="" src="/usermodule/images/apitop.png" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="line_01" style="padding-left: 20px;">
                    <span style="background-color: #fd960b; color: White; font-weight: bold; padding: 2px 5px 2px 5px;">
                        <%= getapikey %></span>&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:LinkButton ID="btnModiKey" runat="server" CssClass="btn btn-primary" 
                        onclick="btnModiKey_Click1">重置密钥</asp:LinkButton>
                </td>
                <td height="50" align="left" class="line_01">
                </td>
            </tr>
            <tr>
                ...
                <td align="left" class="line_01" style="padding-left: 20px; border: none;">
                    <a href="/usermodule/account/download/api_example.zip" target="_blank" class="btn btn-primary">亿付支付网银接口说明文档【点击下载】</a> <!--<a href="/usermodule/account/download/亿付支付点卡接口说明文档.rar"
                        target="_blank" class="btn btn-primary">亿付支付接口说明文档【点击下载】</a>-->
                </td>
        ...
        <div class="alert alert-info">
            <p>
                1.API接口提交卡需要对接亿付支付接口</p>
            <p>
                2.安全码是对接唯一的加密密钥，请妥善保管</p>
            <p>
                3.在接口对接时，如果遇到问题可联系研发人员.</p>
            <p>
