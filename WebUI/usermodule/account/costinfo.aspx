<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="costinfo.aspx.cs" Inherits="viviAPI.WebUI7uka.usermodule.account.Costinfo" %>
...
<body>
    ...
    <div id="list_content">
                ...
                <td height="50" align="left" >
                    <span style="color: #3a87ad; font-size: 20px; font-weight: bold; line-height: 50px;
                        padding-left: 20px;">结算信息</span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #ff0000;">通过实名认证后
                            可以申请变更</span><a href="/usermodule/safety/safetrna.aspx" target="mainframe" style="color: #3a87ad;
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 2px solid #e1e7f1;">
            <tr>
                <td height="39" align="right"  style="width: 150px; background: #e1e7f1;">
                    结算周期：
                </td>
                <td align="left"  style="padding-left: 15px;">
                    ...
                    <div style="float: right; text-align: left; margin-right: 80px;">
                        <span style="font-weight: bold; color: Red;">申请结算模式变更请联系平台客服：</span><a target="_blank"
                            href="http://wpa.qq.com/msgrd?v=3&uin=325915361&site=qq&menu=yes"><img border="0"
                                src="http://wpa.qq.com/pa?p=2:177701489:51" alt="点击这里给我发消息" title="点击这里给我发消息" /></a>
                        <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=325915362&site=qq&menu=yes">
                            <img border="0" src="http://wpa.qq.com/pa?p=2:177701481:51" alt="点击这里给我发消息" title="点击这里给我发消息" /></a></div>
                </td>
            </tr>
            <tr>
                <td height="39" align="right"  style="width: 150px; background: #e1e7f1;
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 2px solid #e1e7f1;">
            <tr>
                ...
                <td  style="padding-left: 15px; line-height: 42px; color: #ff0000;
                    font-weight: bold;">
                    <%--结算信息变更后需联系商户审核才可以使用--%>
                </td>
            </tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td height="60" align="center" class="font8">
                    ...
                    &nbsp;
                    <asp:Button ID="btnSave" runat="server" Text="提交更改" CssClass="btn btn-primary" OnClick="btnSave_Click" />
