            ...
            <div class="mm-kb" style="text-align: left; padding-left: 150px; margin-top: -1px;">
                ...
                <p>
                    您需要找回密码的帐户名是 <span style="color: #FF6600; font-size: 14px; font-weight: bold">
                        <asp:Literal ID="lituserName" runat="server"></asp:Literal></span> ，请选择您已开通的方式找回密码：</p>
                <div class="getway">
                    <div class="back-form" name="back-form" id="back-form" method="get">
                        ...
                        <p id="p1" runat="server" style="padding: 8px 0">
                            <label for="put1">
                                密保问题：</label><asp:Literal ID="litquestion" runat="server"></asp:Literal></p>
                        <p id="p2" runat="server" style="padding: 8px 0">
                            <label for="put1">
                                密保答案：</label><input type="text" class="input" name="put1" id="txtanswer1" runat="server" /></p>
                        <p id="p3" runat="server" style="padding: 8px 0">
                            <label for="put1">
                                邮箱地址：</label><input type="text" class="input" name="put1" id="txtuseremail" runat="server" /></p>
                        <p id="p4" runat="server" style="padding: 8px 0">
                            <label for="put1">
                                手机号码：</label><input type="text" class="input" name="put1" id="txtphone" runat="server" /></p>
                        <p class="b_m_t">
                            <label for="checkCode">
                                验&nbsp;&nbsp;证&nbsp;码：</label>
