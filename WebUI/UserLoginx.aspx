<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLoginx.aspx.cs" Inherits="viviAPI.WebUI7uka.UserLoginx" %>

<div style="overflow-y: auto; min-height: 220px; max-height: 550px" id="userlogin_dialog_content" class="modal-body">
    ...
    <div id="userloginformdiv">
        <form id="loginform" class="form-horizontal" method="post" action="/checklogin_new.aspx" novalidate="novalidate">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    <td align="left">
                                        <input style="width: auto; float: left; margin-right: 5px" id="username" class="form-control" type="text" name="username" placeholder="请输入用户名">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="th" width="90" align="right">
                                    ...
                                    <td align="left">
                                        <input style="width: auto; float: left; margin-right: 5px" id="userpass" class="form-control" value="" type="password" name="userpass" placeholder="请输入用户密码">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <input style="width: 160px; float: left; margin-right: 15px" id="validateCode" class="form-control"
                                            ...
                                            placeholder="输入右边图片中字符"><img style="float: left" id="validatecodeimg2" onclick="refreshValidateimg(this)"
                                                src="/Vercode.aspx?w=120&amp;h=50&amp;t=1407464634312">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label id="PersistentCookie_label" for="PersistentCookie" jquery191026878185290212075="172"
                                            ...
                                            3月内免登录</label>
                                        <br>
                                        <span class="text-muted"><a href="/findpwd.aspx" target="_top">忘记密码？</a></span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        jq(function() {
            ...
            window.$loginvalidator = jq("#loginform").validate({
                ...
                submitHandler: function(form) {
                    ...
                    var host = http + 'www.59az.com';
                    var systemurl = host + '/index.aspx';
        ...
        1
               <%-- <strong class="text-muted">已有帐户登录</strong><br>
                ...
                <a class="btn btn-large btn-info sns-login-btn" title="QQ帐户登录" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&amp;client_id=100565171&amp;redirect_uri=http%3A%2F%2Fwww.sudu.cn%2Fqq%2Fredirect_uri.php&amp;state=ed40ff66296963c4998629eb588ac326">
                    <span class="sns-icon qq"></span>QQ帐户</a>--%>
                    </div>
