<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="viviAPI.WebUI7uka.WebForm1" %>

<div aria-hidden="false" style="display: block" id="userlogin_dialog" class="modal fade in"
    role="dialog" tabindex="-1" jquery1910027197293317082815="50">
            ...
            <div style="overflow-y: auto; min-height: 220px; max-height: 550px" id="userlogin_dialog_content"
                ...
                <div style="overflow-y: auto; min-height: 220px; max-height: 550px" id="userlogin_dialog_content"
                    ...
                    <div id="userloginformdiv">
                        <form id="loginform" class="form-horizontal" method="post" action="/checklogin_new.ashx"
                        novalidate="novalidate" jquery1910027197293317082815="56">
                        <input type="hidden" name="thirdparty" placeholder="杈撳叆鍙宠竟鍥剧墖涓瓧绗�">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <input style="width: auto; float: left; margin-right: 5px" id="username" class="form-control error"
                                                            name="username" placeholder="杈撳叆鍙宠竟鍥剧墖涓瓧绗�"><label class="error" for="username"
                                                                for="username">请填写用户名</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="th" width="90" align="right">
                                                    ...
                                                    <td align="left">
                                                        <input style="width: auto; float: left; margin-right: 5px" id="userpass" class="form-control error"
                                                            value="" type="password" name="userpass" placeholder="杈撳叆鍙宠竟鍥剧墖涓瓧绗�"><label class="error"
                                                                for="userpass" for="userpass">请填写密码</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <input style="width: 160px; float: left; margin-right: 15px" id="validateCode" class="form-control error"
                                                            onfocus="refreshValidateimg(this,'validatecodeimg2')" name="validateCode" placeholder="杈撳叆鍙宠竟鍥剧墖涓瓧绗�"><img
                                                                style="float: left" id="validatecodeimg2" onclick="refreshValidateimg(this)"
                                                                src="/Vercode.aspx?w=85&amp;h=34&amp;t=1407465861437"><label class="error" for="validateCode"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="https_input">
                                                            <input id="https_input" value="yes" checked type="checkbox" name="https" placeholder="杈撳叆鍙宠竟鍥剧墖涓瓧绗�">
                                                            安全加密通道</label>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <label id="PersistentCookie_label" for="PersistentCookie" data-original-title="为了确保您的信息安全，请不要在网吧或者公共机房选择此项"
                                                            data-placement="top" data-toggle="tooltip" jquery191026878185290212075="172">
                                                            <input style="float: left; margin-right: 5px" id="PersistentCookie" onclick="return checkCookie(this)"
                                                                value="yes" type="checkbox" name="PersistentCookie" placeholder="杈撳叆鍙宠竟鍥剧墖涓瓧绗�">
                                                            3月内免登录</label>
                                                        <br>
                                                        <span class="text-muted"><a href="http://localhost:99/getpass.php" target="_top">忘记密码？</a></span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
...
<a href="#" title="支付宝帐户登录" onclick="document.forms['alipaysubmit'].submit();return false;" class="btn btn-large btn-info sns-login-btn"><span class="sns-icon alipay"></span>支付宝帐户</a>
                        ...
                        <input style="display: none" value="提交查询内容" type="submit" placeholder="杈撳叆鍙宠竟鍥剧墖涓瓧绗�">
                        </form>
                    </div>
        ...
        //]]>
                ...
                <div class="otherlogmodes-left">
                    ...
                    <a style="display: none" class="sudu-sns-btn btn btn-large btn-info sns-login-btn"
                        title="华夏名网帐户登录" onclick="loginWithSuduSns();return false;" href="http://localhost:99/index.aspx#">
                        <span class="sns-icon sudu"></span>本站会员</a> <a class="btn btn-large btn-info sns-login-btn"
                            ...
                            href="http://localhost:99/index.aspx#"><span class="sns-icon alipay"></span>支付宝帐户</a>
                    <a class="btn btn-large btn-info sns-login-btn" title="QQ帐户登录" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&amp;client_id=100565171&amp;redirect_uri=http%3A%2F%2Fwww.sudu.cn%2Fqq%2Fredirect_uri.php&amp;state=ed40ff66296963c4998629eb588ac326">
                        <span class="sns-icon qq"></span>QQ帐户</a></div>
            </div>
            <div id="userlogin_dialog_footer" class="modal-footer">
                <button class="btn btn-info loginbtn" jquery1910027197293317082815="47">
                    登&nbsp;&nbsp;&nbsp;录</button></div>
            <div class="otherlogmodes-left">
                <strong class="text-muted">已有帐户登录</strong><br>
                <a style="display: none" class="sudu-sns-btn btn btn-large btn-info sns-login-btn"
