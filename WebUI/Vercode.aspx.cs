    ...
    public partial class Vercode : System.Web.UI.Page  
   {
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			try
			{
                ...
                LinearGradientBrush brush = new LinearGradientBrush(new Rectangle(0, 0, bitmap.Width - num2, bitmap.Height), Color.Maroon, Color.Maroon, 1.2f, true);
		...
		public static void CreateCheckCodeImage(int count)
		{
			...
			if (text != null && text.Trim() != string.Empty)
			{
				...
				try
				{
					...
					LinearGradientBrush brush = new LinearGradientBrush(new Rectangle(0, 0, bitmap.Width, bitmap.Height), Color.Green, Color.OrangeRed, 1.2f, true);
