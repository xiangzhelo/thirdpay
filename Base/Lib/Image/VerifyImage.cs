...
namespace viviLib.Image
{
    public class VerifyImage
    {
        ...
        private static Font[] fonts = {
                                        new Font(new FontFamily("Times New Roman"), 20 + Next(3), FontStyle.Regular),
                                        new Font(new FontFamily("Georgia"), 20 + Next(3), FontStyle.Regular),
                                        new Font(new FontFamily("Arial"), 20 + Next(3), FontStyle.Regular),
                                        new Font(new FontFamily("Comic Sans MS"), 20 + Next(3), FontStyle.Regular)
                                     };
