...
namespace viviapi.BLL.Settled
{
    public partial class transfer
    {
      ...
      ,[full_name1]";
        ...
        ///  增加一条数据
        /// </summary>
        public int Add(Model.Settled.transfer model)
        {
            try
            {
                int rowsAffected;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.Settled.transfer model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.Settled.transfer GetModel(int id)
        {
            ...
            Model.Settled.transfer model = new Model.Settled.transfer();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.Settled.transfer DataRowToModel(DataRow row)
        {
            Model.Settled.transfer model = new Model.Settled.transfer();
            if (row != null)
            {
