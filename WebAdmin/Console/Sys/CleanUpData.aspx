<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviAPI.WebAdmin.Console.Sys.Console_CleanUpData" Codebehind="CleanUpData.aspx.cs" %>
            ...
            <tr bgcolor="#F7F3F7">
                ...
                <td>
                    <asp:CheckBoxList ID="cbl_clearType" runat="server" RepeatDirection="Horizontal">
                        ...
                        <asp:ListItem Value="cardsend">点卡递交</asp:ListItem>  
                        <asp:ListItem Value="ordercardsuppchange">交易返回数据</asp:ListItem>
