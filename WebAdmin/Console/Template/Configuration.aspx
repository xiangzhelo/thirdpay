<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviAPI.WebAdmin.Console.Template.Configuration" Codebehind="Configuration.aspx.cs" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3">
            <tr>
                <td colspan="4" class="tbtitle">短信配置</td>
            </tr>
            <tr>
                <td width="10%" class="td2">
                    短信平台SN：</td>
                <td width="90%" colspan="3" class="td1">
                    <asp:TextBox ID="txtSN" runat="server" Width="800px"></asp:TextBox></td>
            </tr>
            <tr>
                <td width="10%" class="td2">
                    短信平台KEY：</td>
                <td width="90%" colspan="3" class="td1">
                    <asp:TextBox ID="txtKey" runat="server" Width="800px"></asp:TextBox></td>
            </tr>
            <tr>
                <td width="10%" class="td2">
                    短信平台接口地址：</td>
                <td width="90%" colspan="3" class="td1">
                    <asp:TextBox ID="txtWebSite" runat="server" Width="800px"></asp:TextBox></td>
            </tr>
            <tr>
                <td width="10%" class="td2">
                    短信发送成功返回值：</td>
                <td width="90%" colspan="3" class="td1">
                    <asp:TextBox ID="txtSuccessCode" runat="server" Width="800px"></asp:TextBox></td>
            </tr>
            <tr>
                <td width="10%" class="td2">
                    注册内容模板：</td>
                <td width="90%" colspan="3" class="td1">
                    <asp:TextBox ID="TextBox3" runat="server" Width="800px">尊敬的商户您好，非常感谢您注册{@sitename}。您的注册码是{@authcode}。【@sitename】</asp:TextBox></td>
            </tr>
            <tr>
                <td width="10%" class="td2">
                    注册内容模板：</td>
