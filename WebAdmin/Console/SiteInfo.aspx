<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviAPI.WebAdmin.Console.SiteInfo" ValidateRequest="false" Codebehind="SiteInfo.aspx.cs" %>
            ...
            <tr>
             ...
             <tr>
                <td class="td2">
                     用户默认结算模式：</td>
                <td class="td1" colspan="3">
                     <asp:DropDownList ID="ddlDefaultScheme" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
