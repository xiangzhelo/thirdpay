...
namespace viviAPI.WebAdmin.Console.manage
{
    ...
    /// 
    /// </summary>
    public partial class xTrades : viviapi.WebComponents.Web.ManagePageBase
    {
...
, ManageRole.Financial);
        ...
        private void LoadData()
        {
            ...
            DataSet pageData = viviapi.BLL.Settled.ManageTrade.PageSearch(listParam, this.Pager1.PageSize, this.Pager1.CurrentPageIndex, orderby);
