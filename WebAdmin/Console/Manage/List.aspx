<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviAPI.WebAdmin.Console.manage.Manage" Codebehind="List.aspx.cs" %>
                ...
                <td align="center">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <a href="Edit.aspx?cmd=edit&amp;ID=<%# Eval("ID") %>">编辑</a> | 
                                    <a href="ChangePwd.aspx?cmd=edit&amp;ID=<%# Eval("ID") %>">修改密码</a>|
                                    <a href="ChangePwd2.aspx?cmd=edit&amp;ID=<%# Eval("ID") %>">修改二级密码</a>|
