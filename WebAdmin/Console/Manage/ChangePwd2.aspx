<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviAPI.WebAdmin.Console.Manage.ChangePwd2" Codebehind="ChangePwd2.aspx.cs" %>
                                    ...
                                    <table id="setpsd" style="margin-bottom: 5px" cellspacing="1" cellpadding="1" width="99%"
                                        ...
                                        <tr>
                                            ...
                                            <td width="81%" height="30" align="left">
                                                <asp:Label ID="lblManage" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                            ...
                                            <td align="left" height="30">
                                                <input id="old_password" runat="server" class="reg"  type="password" name="pas" style="width: 120px"/></td>
                                        </tr>
                                        <tr>
                                            <td align="right" width="19%">
                                                您的二级密码：</td>
