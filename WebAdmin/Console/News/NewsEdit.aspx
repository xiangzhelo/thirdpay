<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsEdit.aspx.cs" Inherits="viviAPI.WebAdmin.Console.News.NewsEdit" ValidateRequest="false" %>
            ...
            <td>
                <table style="border: 1px;" cellpadding="0" cellspacing="0" class="table01">
                    ...
                    <tr>
                        ...
                        <td align="left" >
                            <script id="editor" type="text/plain" style="width:1024px;height:500px;"><%=Newscontent%></script>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="width: 118px; height: 40px;">
