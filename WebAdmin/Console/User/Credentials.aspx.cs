...
namespace viviAPI.WebAdmin.Console.User
{
    ...
    /// 
    /// </summary>
    public partial class Credentials : ManagePageBase
    {
...
, ManageRole.Merchant);
        ...
        private void LoadData()
        {
            ...
            DataSet pageData = viviapi.BLL.User.usersIdImage.PageSearch(listParam, this.Pager1.PageSize, this.Pager1.CurrentPageIndex, orderby);
