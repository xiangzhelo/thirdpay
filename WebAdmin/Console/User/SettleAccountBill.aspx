<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviAPI.WebAdmin.Console.User.SettleAccountBill" Codebehind="SettleAccountBill.aspx.cs" %>
                    ...
                    <asp:Repeater ID="rptApps" runat="server" 
                        ...
                        <ItemTemplate>
                            <tr style="background-color: #EFF3FB">
                                ...
                                <td>
                                    <%# viviapi.BLL.User.SettlementAccount.GetSettleModeName(Eval("pmode"))%>
                                </td>
                                <td>
                                    <%# viviapi.BLL.Withdraw.ChannelWithdraw.GetSettleBankName(Eval("payeeBank").ToString())%>
                                </td>
                                <td>
                                     <%# Eval("account")%>（<%#viviapi.BLL.User.SettlementAccount.GetAccoutTypeName(Eval("accoutType"))%>）
                                </td>
                                 <td>
                                    <%# Eval("payeeName")%>
                                </td>
