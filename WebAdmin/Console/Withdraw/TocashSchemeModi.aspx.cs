...
namespace viviAPI.WebAdmin.Console.Withdraw
{
    ...
    /// 
    /// </summary>
    public partial class TocashSchemeModi : ManagePageBase
    {
        ...
        private TocashSchemeInfo _itemInfo = null;
        ...
        private void InitForm()
        {
            if (isUpdate)
            {
                ...
                cbk_lowerlimit.Checked = model.lowerLimit == 1;
                cbk_upperlimit.Checked = model.upperLimit == 1;
            }
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            model.tranRequiredAudit = Convert.ToByte(this.rbltranRequiredAudit.SelectedValue);

            model.lowerLimit = Convert.ToByte(cbk_lowerlimit.Checked ? 1 : 0);
            model.upperLimit = Convert.ToByte(cbk_upperlimit.Checked ? 1 : 0);
            ...
            if (success)
            {
                AlertAndRedirect("操作成功", "TocashSchemes.aspx");
            }
            else
            {
