                        ...
                        <asp:Repeater ID="rptdata" runat="server" 
                            ...
                            <ItemTemplate>
                                <tr bgcolor="#EFF3FB">
                                    ...
                                    <td style="text-align: center">
                                        <asp:Button ID="btnAudit" runat="server" Text="通过" CommandName="Pass" CommandArgument='<%# Eval("tranno") %>'  />
                                        <asp:Button ID="btnRefuse" runat="server" Text="拒绝" CommandName="Refuse" CommandArgument='<%# Eval("tranno") %>'  />
                                    </td>                                    
                                </tr>
                            </ItemTemplate>
