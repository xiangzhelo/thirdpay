<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviAPI.WebAdmin.Console.Withdraw.SuppTransLogs" Codebehind="SuppTransLogs.aspx.cs" %>
                ...
                <td align="center">
                    <table width="100%" id="tab" border="0" align="center" cellpadding="2" cellspacing="1">
                        <asp:Repeater ID="rptdata"  runat="server" 
                            onitemcommand="rptdata_ItemCommand" onitemdatabound="rptdata_ItemDataBound">
                            <HeaderTemplate>
                            ...
                            <ItemTemplate>
                                <tr style="background-color: #EFF3FB">
                                    ...
                                    <td>
                                        <%# viviapi.BLL.Finance.Withdraw.Instance.GetBankName(Eval("bankCode").ToString())%> <%# Eval("bankBranch")%> <br />
                                    ...
                                    <td>
                                        <%# viviapi.BLL.Finance.WithdrawSuppTranLog.GetStatusText(Eval("status"))%>
                                    </td>
                                     <td>
