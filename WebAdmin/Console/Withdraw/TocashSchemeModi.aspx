<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="viviAPI.WebAdmin.Console.Withdraw.TocashSchemeModi" Codebehind="TocashSchemeModi.aspx.cs" %>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        ...
        <tr>
            ...
            <td class="td1">
                <asp:CheckBox ID="cbk_lowerlimit" runat="server" Text="有最少限制" />
        ...
        <tr>
            ...
            <td class="td1">
                 <asp:CheckBox ID="cbk_upperlimit" runat="server" Text="有最高限制" />
