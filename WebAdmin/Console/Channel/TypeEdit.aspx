<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviAPI.WebAdmin.Console.channel.ChannelTypeEdit"
    CodeBehind="TypeEdit.aspx.cs" %>
...
<body>
    ...
    <div>
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td align="center" colspan="4" class="title">
                    通道类别编辑
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="td1">
                    ...
                    <span style="color: Red">
                        <br />
                        注意按配置 的意思是如果用户设置了通道的开关状态就按用户的设置的状态
                        <br />
                        如果没有 就看具体通道有没有设置通道状态 如果设置就按具体通道的状态
                        <br />
                        如果没有就默认为关闭 或才开启</span>
                </td>
            </tr>
            <tr>
                <td class="td2">
                ...
                <td class="td1">
                    <asp:RadioButtonList ID="rblrunmode" runat="server" RepeatDirection="Horizontal"
                        AutoPostBack="true" OnSelectedIndexChanged="rblrunmode_SelectedIndexChanged">
            ...
            <tr>
                ...
                <td class="td1">
                    <asp:TextBox ID="txtSuppsWhenExceOccurred" runat="server" Width="50%" TextMode="MultiLine"></asp:TextBox>同步提交异常发生时通道逗号分开
                </td>
            </tr>
            <tr>
                <td class="td2">
                ...
                <td class="td1">
                    <asp:TextBox ID="txttimeout" runat="server" Width="200px"></asp:TextBox>
                    单位为毫秒
                </td>
            </tr>
            <tr>
