<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviAPI.WebAdmin.Console.Message.Feedbacks" Codebehind="Feedbacks.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function sendInfo(id) {
            window.open("FeedbackReply.aspx?id=" + id, "审核", "height=500,width=600");
        }
    </script>
