<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviAPI.WebAdmin.Console.Cache.CahceManage" Codebehind="Manage.aspx.cs" %>
                                ...
                                <td>
                                    <table id="setpsd" style="margin-bottom: 5px" cellspacing="1" cellpadding="3" width="100%">
                                        ...
                                        <tr>
                                            <td height="30">
                                            按大类清除：                                             
                                                <asp:CheckBoxList ID="cbl_cacheTypeList" runat="server" Width="100%" RepeatColumns="5">
