...
<head runat="server">
    ...
    <script type="text/javascript">
        function sendInfo(id) {
            window.open("CardDetail.aspx?orderid=" + id, "查看卡类订单明细", "");
        }
    </script>
                ...
                <table>
                    <tr>
                        <td colspan="3">
                            ...
                            &nbsp;&nbsp;卡号：<asp:TextBox ID="txtCardNo" runat="server" Width="120px"></asp:TextBox>
                            &nbsp;&nbsp;开始：
                    ...
                    <tr>
                        <td>
                            ...
                            &nbsp;&nbsp;商户订单号：<asp:TextBox ID="txtUserOrder" runat="server" Width="150px"></asp:TextBox>
                            &nbsp;&nbsp;接口商订单号：<asp:TextBox ID="txtSuppOrder" runat="server" Width="150px"></asp:TextBox>
                        </td>
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFF3FB" ondblclick="javascript:sendInfo('<%# Eval("orderid")%>')">
                                            ...
                                            <td>
                                                ...
                                                <asp:Button ID="btnChange" runat="server" Text="调"  CommandName="Change" CommandArgument='<%# Eval("orderid")%>' Visible="false" />                                             </td>                                            
                                        </tr>
