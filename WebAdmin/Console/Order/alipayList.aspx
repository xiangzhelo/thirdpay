<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviAPI.WebAdmin.Console.Order.alipayList" Codebehind="alipayList.aspx.cs" %>
            ...
            <td>
                ...
                <asp:TextBox ID="txtpromid" runat="server" Width="30px"></asp:TextBox>--%>
                            <%--<asp:DropDownList ID="ddlChannelType" runat="server" Width="95px">
                                ...
                                <asp:ListItem Value="206">支付宝扫码</asp:ListItem>
