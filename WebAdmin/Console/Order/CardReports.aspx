<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviAPI.WebAdmin.Console.Order.CardReports" Codebehind="CardReports.aspx.cs" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function sendInfo(id) {
            window.open("CardDetail.aspx?orderid=" + id, "查看订单", "height=760,width=800");
        }        
    </script>
    <script type="text/javascript">
