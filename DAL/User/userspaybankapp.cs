...
namespace viviapi.DAL.User
{
	...
	/// </summary>
	public partial class userspaybankapp
	{
		public userspaybankapp()
		{}
		#region  BasicMethod
        ...
        public int Insert(Model.User.UserPayBankAppInfo model)
        {
            SqlParameter[] parameters = {
		...
		/// 增加一条数据
		/// </summary>
        public int Add(Model.User.UserPayBankAppInfo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into userspaybankapp(");
			strSql.Append("userid,accoutType,pmode,account,payeeName,payeeBank,bankProvince,bankCity,bankAddress,status,AddTime,SureTime,SureUser,BankCode,provinceCode,cityCode,Reason)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.User.UserPayBankAppInfo model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.User.UserPayBankAppInfo GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,userid,accoutType,pmode,account,payeeName,payeeBank,bankProvince,bankCity,bankAddress,status,AddTime,SureTime,SureUser,BankCode,provinceCode,cityCode,Reason from userspaybankapp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.User.UserPayBankAppInfo model=new Model.User.UserPayBankAppInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.User.UserPayBankAppInfo DataRowToModel(DataRow row)
		{
			Model.User.UserPayBankAppInfo model=new Model.User.UserPayBankAppInfo();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,userid,accoutType,pmode,account,payeeName,payeeBank,bankProvince,bankCity,bankAddress,status,AddTime,SureTime,SureUser,BankCode,provinceCode,cityCode,Reason ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,userid,accoutType,pmode,account,payeeName,payeeBank,bankProvince,bankCity,bankAddress,status,AddTime,SureTime,SureUser,BankCode,provinceCode,cityCode,Reason ");
			strSql.Append(" FROM userspaybankapp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
