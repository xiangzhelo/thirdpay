...
namespace viviAPI.Gateway2018.StandardAPI.YZCH
{
    ...
    /// 
    /// </summary>
    public partial class Pay : BankTransBase
    {
        ...
        public string sysBankcode
        {
            get
            {
                return viviapi.SysInterface.Bank.Card70.ConverBankCode(bankid);
            }
        }
        #endregion
        ...
        public string attach
        {
            get
            {
                return HttpUtility.UrlDecode(WebBase.GetQueryStringString("ext", ""), System.Text.Encoding.GetEncoding("GB2312"));
            }
        }
        #endregion
        ...
        public string version
        {
            get
            {
                return viviapi.SysInterface.Bank.Card70.Vb7010;
            }
        }
        #endregion
