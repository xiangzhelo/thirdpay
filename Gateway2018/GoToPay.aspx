<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoToPay.aspx.cs" Inherits="viviAPI.Gateway2018.GoToPay" %>
...
<head>
    <title>正在连接银行</title>
    <link href="/static/style/css.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <asp:Literal ID="litpayform" runat="server"></asp:Literal>
                    ...
                    <tr>
                        <td valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align: center;
                                ...
                                <tr>
                                    <td height="60">
                                        <img src="/static/images/icon_tdwaiting.gif" width="32" height="32" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input type="button" name="button1" onclick="javascript:window.location='/Connect/Report.aspx'" id="button1" value="点我举报" style="height: 30px; border: 1px solid #ccc; color: Red;" /><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
    ...
    <script src="/static/js/gotopay.js" type="text/javascript"></script>
</body>
</html>
