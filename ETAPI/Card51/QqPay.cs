...
namespace viviapi.ETAPI.Card51
{
    public class QqPay: ETAPIBase
    {
        ...
        public static QqPay Instance
        {
            get
            {
                var instance = new QqPay();
                return instance;
            }
        }


        internal string Returnurl { get { return this.SiteDomain + "/return/card51/QqPay.aspx"; } }
        internal string NotifyUrl { get { return this.SiteDomain + "/receive/card51/QqPay.aspx"; } }
        ...
        {
            //提交地址
            string form_url = "http://www.51card.cn/gateway/qqpay/qqpay.asp";
            //商户号
