...
namespace viviapi.ETAPI.Card51
{
    ...
    /// 51Card微信接口
    /// </summary>
    public class WapWeiXin : ETAPIBase
    {
        ...
        public static WapWeiXin Instance
        {
            get
            {
                var instance = new WapWeiXin();
                return instance;
            }
        }


        internal string Returnurl { get { return this.SiteDomain + "/return/card51/wapweixin.aspx"; } }
        internal string NotifyUrl { get { return this.SiteDomain + "/receive/card51/wapweixin.aspx"; } }
        ...
        {
            //提交地址
            string form_url = "http://www.51card.cn/gateway/weixinpay/wap-weixinpay.asp";
            //商户号
