...
{
    public class WxMobilePay : ETAPIBase
    {
        private static int suppid = (int)SupplierCode.HeePay;
        public WxMobilePay() : base(suppid) { }
        ...
        public static bool IsMobile
        {
            get
            {
                Regex RegexMobile = new Regex(@"(iemobile|iphone|ipod|android|nokia|sonyericsson|blackberry|samsung|sec\-|windows ce|motorola|mot\-|up.b|midp\-)", RegexOptions.IgnoreCase);
        ...
        public void Notify(HttpContext context, bool isNotify)
        {
            string opstate = "-1";
            int status = 4;
