...
namespace viviapi.ETAPI.ebao
{
    ...
    {
        private ILog log = LogManager.GetLogger("ETAPILogger");
        ...
        public string RequestResult(string actionType, NameValueCollection nvc, string keyvalue, string postUrl, string httpFlag = "1")
        {
            string hmacResource = "";
            string postParams = "";
            ...
            log.Debug(actionType + ":\t sbold:" + hmacResource);
            string hmac = Digest.HmacSign(hmacResource, keyvalue);
            log.Debug(actionType + ":\t keyvalue" + ":" + keyvalue + "\thmac" + ":" + hmac);
            ...
            {
                // 记录重定向请求的url
                log.Debug(actionType + ":\t requestUrl:" + postUrl + "?" + postParams);
            ...
            else
            {
                ...
                log.Debug(actionType + "\t returnMsg:" + resultStr);
    ...
    public class doResponseHttp
    {
        ...
        public string getCallBackParams(NameValueCollection nvc, string keyvalue)
        {
            ...
            log.Debug("Buy \t serverhmac" + ":" + nvc["hmac"] + "localhmac" + ":" + "[" + hmac + "]");
