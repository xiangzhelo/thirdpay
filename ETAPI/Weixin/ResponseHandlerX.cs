...
namespace viviapi.ETAPI.tenpay.tenpayLib
{
    ...
    */
    ...
    public class ResponseHandlerX
    {
        static log4net.ILog log2 = log4net.LogManager.GetLogger("ETAPILogger");
        ...
        //获取页面提交的get和post参数
        public ResponseHandlerX(HttpContext httpContext)
        {
            parameters = new Hashtable();
            xmlMap = new Hashtable();
        ...
        public string getParameter2(string parameter)
        {
        ...
        public virtual Boolean isWXsign()
        {
            try
            {
                ...
                return sign.Equals(xmlMap["AppSignature"].ToString());
            }
